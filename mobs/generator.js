...
function generateYaml() {
  ...
  var yamlTitle =
    "Put this as the name of the file:<br />" +
    "<strong>" +
    yamlName +
    "." +
    mobType +
  ...
  document.getElementById("customTag").innerHTML =
    '<span style="background-color: #cecece;"' + yamlTitle + "</span>";
...
function createSpell() {
  spells.insertAdjacentHTML(
    ...
    '<div class="spellContainer' +
      ...
      '"><strong>Spell ' +
      (spellNumber + 1) +
      '</strong> <select id="sselect' +
      spellNumber +
      '" name="spell' +
      spellNumber +
      '"></label><option value="ARROW_STORM">Arrow Storm</option><option value="HEAVY_ARROW_STORM">Heavy Arrow Storm</option><option value="CHARGE">Charge</option><option value="HEAVY_CHARGE">Heavy Charge</option><option value="FLAME_THROWER">Flame Thrower</option><option value="HEAVY_FLAME_THROWER">Heavy Flame Thrower</option><option value="HEAL">Heal</option><option value="HEAVY_HEAL">Heavy Heal</option><option value="METEOR">Meteor</option><option value="MULTIHIT">Multihit</option><option value="HEAVY_MULTIHIT">Heavy Multihit</option><option value="PULL">Pull</option><option value="HEAVY_PULL">Heavy Pull</option><option value="PUSH">Push</option><option value="HEAVY_PUSH">Heavy Push</option><option value="SELF_DESTRUCT">Self Destruct</option><option value="SLOWNESS">Slowness</option><option value="HEAVY_SLOWNESS">Heavy Slowness</option><option value="SPIDERWEB">Spiderweb</option><option value="TELEPORT">Teleport</option><option value="HEAVY_TELEPORT">Heavy Teleport</option><option value="VANISH">Vanish</option><option value="HEAVY_VANISH">Heavy Vanish</option><option value="WEAKNESS">Weakness</option><option value="HEAVY_WEAKNESS">Heavy Weakness</option></select></p><p><label><strong>Cooldown ' +
      (spellNumber + 1) +
      '</strong> <input autocomplete="off" type="number" value="20" id="scool' +
      spellNumber +
      '"></label></p><p><label><strong>Damage ' +
      (spellNumber + 1) +
      '</strong> <input autocomplete="off" type="number" value="0" id="sdam' +
      spellNumber +
      '"></label></p><br /></div>'
  );
